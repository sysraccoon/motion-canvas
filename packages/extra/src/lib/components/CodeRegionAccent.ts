...
export class CodeRegionAccent extends Rect {
  ...
  public constructor(props?: CodeRegionAccentProps) {
    super({
      ...
      position: () =>
        this.accentRegion()
          .center.transformAsPoint(this.code().localToWorld())
  ...
  public *changeRegionByRegex(
    selector: string | RegExp,
    duration: number,
    timingFunc: TimingFunction = easeOutCirc,
  ) {
    yield* this.accentRegion(
      () => bboxByRegex(this.code(), selector),
      duration,
      timingFunc,
    );
  }
  ...
  public *changeRegionByCodeRanges(
    ranges: CodeRange[],
    duration: number,
    timingFunc: TimingFunction = easeOutCirc,
  ) {
    yield* this.accentRegion(
      () => bboxByCodeRanges(this.code(), ...ranges),
      duration,
      timingFunc,
    );
  }
