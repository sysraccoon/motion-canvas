...
export class Key extends Rect {
  ...
  public *tap(
    duration: number = 0.8,
    holdDurationRatio: number = 0.5,
    onTap?: ThreadGenerator,
  ) {
  ...
  private createLabels(labels: KeyLabels): Txt[] {
    ...
    addLabelIfDef(
      labels?.topLeft,
      () => cardinalToLocal(this.topLeft()),
      [-1, -1],
    );
    addLabelIfDef(labels?.top, () => cardinalToLocal(this.top()), [0, -1]);
    addLabelIfDef(
      labels?.topRight,
      () => cardinalToLocal(this.topRight()),
      [1, -1],
    );
    ...
    addLabelIfDef(
      labels?.bottomLeft,
      () => cardinalToLocal(this.bottomLeft()),
      [-1, 1],
    );
    addLabelIfDef(labels?.bottom, () => cardinalToLocal(this.bottom()), [0, 1]);
    addLabelIfDef(
      labels?.bottomRight,
      () => cardinalToLocal(this.bottomRight()),
      [1, 1],
    );
